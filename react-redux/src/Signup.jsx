...
function Signup() {
    // getting the text input data and image data
    ...
    const sendData = async () => {
        ...
        try {
            ...
            if (response.status == 200) {
                ...
                // there we would be sending an action for the reducer and save data
                ...
                console.log('not been able to signup the user successfully');
            }

        }
        catch (error) {
            console.log(`We have faced some error: ${error}`)
        }
    }
